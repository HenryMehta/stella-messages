...
@login_required
def compose(request, recipient=None, form_class=ComposeForm, subject=None,
...
def reply(request, message_id, form_class=ComposeForm,
    ...
    mysubject = subject_template % {'subject': parent.subject}
    print mysubject
    if not 'Re: ' in mysubject: mysubject = "Re: " + mysubject
    print mysubject
